...
```{r}
#| code-fold: true
#| label: fig-compare-exp-obs
#| fig-cap: "The investigator is interested in studying the direct effect of `treatment` on `outcome`. A natural system compared to another system in which the investigator has intervened to simplify the system with respect to data analysis."
#| fig-subcap: 
#|   - "System as it operates naturally."
#|   - "System with investigator intervention."
#| layout-ncol: 2
Natural <- dag_make(
  covar ~ exo(),
  unknown ~ exo(),
...
```{r}
#| code-fold: true
#| fig-label: "The situation when experimental units don't necessarily comply with their assigned `treatment`."
#| label: fig-intent-to-treat
Intent <- dag_make(
  investigator ~ exo(),
  covar ~ exo(),
  unknown ~ exo(),
